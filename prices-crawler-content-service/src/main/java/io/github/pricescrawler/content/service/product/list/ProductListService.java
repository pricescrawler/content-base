...
public interface ProductListService {
     ...
     */
    Mono<List<ProductListItemDto>> retrieveProductList(String id);
     ...
     */
    Mono<ProductListShareDto> storeProductList(List<ProductListItemDto> productListItems);

    /**
     * Deletes any product lists that have exceeded their expiration time.
     */
    Mono<Void> deleteOutdatedProductLists();
}

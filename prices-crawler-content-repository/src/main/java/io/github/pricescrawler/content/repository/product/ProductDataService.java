...
public interface ProductDataService {
    ...
    /**
     * Retrieves products based on the specified criteria.
     *
     ...
     * @return A Flux of ProductDao objects matching the specified criteria.
     */
    Flux<ProductDao> findProducts(String locale, String catalog, String reference);

    /**
     * Retrieves products based on the provided EAN/UPC code.
     *
     * @param eanUpc The EAN (European Article Number) or UPC (Universal Product Code) for identifying products.
     * @return A Flux of ProductDao objects matching the specified EAN/UPC code.
     */
    Flux<ProductDao> findProductsByEanUpc(String eanUpc);
     ...
     * @return a Mono that completes when all products are saved
     */
    Mono<Void> save(List<ProductDto> productDtoList);
}

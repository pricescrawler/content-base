...
public interface ProductCacheService {
    ...
    /**
     * Stores a list of products for the specified locale, catalog, and reference.
     *
     ...
     */
    void storeProductList(String locale, String catalog, String reference, List<ProductDto> products);
    ...
    /**
     * Clears outdated products from the cache.
